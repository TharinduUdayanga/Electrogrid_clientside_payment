...
<nav class="navbar navbar-expand-md navbar-dark" style="background-color: 	#5353ff">
                    ...
                    <ul class="navbar-nav">
                        <li><a href="Login.jsp" class="nav-link">ElectroGrid Online Platform</a></li>
                    </ul>
                </nav>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <h6>About</h6>
            <p class="text-justify">R.M.T.U.Rajapakse<i> </i> This project is based on a company named ElectroGrid . My task was to create the online platform covering the whole scope of the company. I used java , tomcat , mysql and JAX-RS Restful webservice as our tools to create our platform..</p>
          </div>
